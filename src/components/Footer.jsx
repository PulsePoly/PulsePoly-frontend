        ...
        <div className={`footer-content ${isExpanded ? 'expanded' : ''}`}>
          ...
          <div className="footer-section">
            ...
            <div className="footer-social-icons">
              <a href="https://github.com/PulsePoly" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="GitHub">
              ...
              <a href="https://t.me/pulsepolybot" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Telegram">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
