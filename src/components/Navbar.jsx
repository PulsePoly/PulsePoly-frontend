    ...
    <nav className={`navbar ${isScrolled ? 'shrink' : ''}`}>
      <div className="navbar-buttons-container">
        ...
        <div className="navbar-social-icons">
          ...
          <a href="https://github.com/PulsePoly" target="_blank" rel="noopener noreferrer" className="navbar-social-icon" aria-label="GitHub">
          ...
          <a href="https://t.me/pulsepolybot" target="_blank" rel="noopener noreferrer" className="navbar-social-icon" aria-label="Telegram">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
